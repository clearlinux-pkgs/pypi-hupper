...
Source0  : https://files.pythonhosted.org/packages/bd/e6/bb064537288eee2be97f3e0fcad8e7242bc5bbe9664ae57c7d29b3fa18c2/hupper-1.12.1.tar.gz
...
%prep
%setup -q -n hupper-1.12.1
cd %{_builddir}/hupper-1.12.1
pushd ..
cp -a hupper-1.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708367968
